...
public class FightBetweenTwoHeroesTest {
    Logger logger= Logger.getLogger(FightBetweenTwoHeroesTest.class);
    ResponseBody responseObject = null;

    @Test(description = "Creating and verifying able to make the hero fight (or) not : ",
            dataProvider = "startFightWith2HeroesData",
            dataProviderClass = TestDataProviders.class,
            priority = 8,
            enabled = true,
            alwaysRun = true)
    public void api_08_VerifyMakeHeroFight(String runMode, String scenario, int expectedResponseCode, String message) {
