...
public class FightWithSingleHeroTest {
    ...
    @Test(description = "Creating and verifying able to make the hero fight (or) not : ",
            dataProvider = "startFightWithSingleHeroData",
            dataProviderClass = TestDataProviders.class,
            priority = 07,
            enabled = true,
            alwaysRun = true)
    public void api_07_VerifyMakeHeroFight(String runMode, String scenario, int expectedResponseCode, String message) {
