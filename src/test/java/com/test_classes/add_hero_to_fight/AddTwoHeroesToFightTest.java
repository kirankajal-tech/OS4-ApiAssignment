...
public class AddTwoHeroesToFightTest {
    Logger logger = Logger.getLogger(AddTwoHeroesToFightTest.class);
    ResponseBody responseObject = null;

    @Test(description = "Creating and verifying able to add two Heroes to fight : ",
            dataProvider = "add2HeroesToFightData",
            dataProviderClass = TestDataProviders.class,
            priority = 04,
            enabled = true,
            alwaysRun = true)
    public void api_04_VerifyAddingTwoHeroesToFight(String runMode, String scenario, String heroId, int expectedResponseCode, String message) {
